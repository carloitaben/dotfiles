...
vim.keymap.set('n', '<D-p>', find_files_reversed, { desc = 'Search files' })
...
vim.keymap.set('n', '<leader>sf', find_files_reversed, { desc = 'Search files' })
...
vim.keymap.set('n', '<leader>su', telescope.extensions.undo.undo, { desc = 'Search undo history' })
