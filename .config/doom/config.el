...
;; markdown-mode only maps a handful of fence-language shorthands to real
;; major modes (see `markdown-code-lang-modes'); "ts"/"tsx"/"js"/"jsx" fall
;; through to fundamental-mode, i.e. no syntax highlighting in the fence.
(after! markdown-mode
...
;; Ghostty supports the Kitty keyboard protocol; this lets terminal Emacs
;; negotiate it too, so ESC is reported unambiguously instead of Emacs
;; waiting to see if more bytes follow (the source of ESC-exit lag in evil).
(use-package! kkp
